...
class TXTReader(BaseDataset):
    def __init__(self, pipeline, ann_file, classes):
        super(TXTReader, self).__init__(pipeline=pipeline, ann_file=ann_file, classes=classes)
    ...
    def load_annotations(self):
        ...
        for (filename, label) in tqdm(imgs):
            ...
            info = {'image': img, 'label': self.class_to_idx[label]}
