...
class InceptionResNetC(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.shorcut = nn.Conv2d(in_channels, 2048, kernel_size=1)
...
class InceptionResNetV2(BaseBackbone):
    def __init__(self, in_channels, num_classes):
        ...
        self.inception_resnet_a = make_layers(384, 384, block_num=5, block=InceptionResNetA)
        self.reduction_a = InceptionResNetReductionA(384, k=256, l=256, m=384, n=384)
        out_channels = self.reduction_a.out_channels
        self.inception_resnet_b = make_layers(out_channels, 1154, block_num=10, block=InceptionResNetB)
        self.reduction_b = InceptionResNetReductionB(1154)
        self.inception_resnet_c = make_layers(2146, 2048, block_num=5, block=InceptionResNetC)
